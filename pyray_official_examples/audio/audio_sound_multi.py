...
# Load the sound list
sound_array[0] = rl.load_sound(str(THIS_DIR/"resources/sound.wav"))  # Load WAV audio file into the first slot as the 'source' sound
                                                                     # this sound owns the sample data
for i in range(1, MAX_SOUNDS):
    sound_array[i] = rl.load_sound_alias(sound_array[0])            # Load an alias of the sound into slots 1-9
