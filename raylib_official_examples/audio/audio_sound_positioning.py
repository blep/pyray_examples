...
def set_sound_position(listener, sound, position, max_dist):
    ...
    forward = rl.vector3_normalize(rl.vector3_subtract(listener.target, listener.position))
...
rl.init_window(screen_width, screen_height, "raylib [audio] example - Playing spatialized 3D sound")
